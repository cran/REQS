...
\usage{
run.eqs(EQSpgm, EQSmodel, serial, data = NA, datname = NA, LEN = 2000000)
...
##res <- run.eqs(EQSpgm = '"C:/Program Files/EQS61/WINEQS"', EQSmodel = "c:/eqs61/examples/manul7.eqs", serial = 1234)
...
##  res <- run.eqs(EQSpgm = '"C:/Program Files/EQS61/WINEQS"', EQSmodel = "c:/eqs61/examples/manul7.eqs", data = X, datname = "manul7.dat", serial = 1234)
